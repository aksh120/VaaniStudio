...
| **Phase 14** | PHASE-14 | Post-MVP Enhancements and Extensibility | Planned (Next) | Local speaker diarization with speaker badges, batch media processing queue, headless command-line interface (vaani-cli). (TASK-060 - TASK-062) |
